        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              PM Security Solution Pvt Ltd has been protecting homes, businesses, and construction sites across Hyderabad with cutting-edge CCTV surveillance systems. As a registered private limited company, our expert team specializes in designing and installing customized security solutions that provide peace of mind and complete protection.
            </p>
