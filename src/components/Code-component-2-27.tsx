        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
              Professional <span className="text-[#2c6e49]">CCTV Solutions</span> for Complete Security
            </h1>
            
            <p className="text-lg text-gray-600 leading-relaxed">
              Comprehensive CCTV installation and monitoring services for residential, commercial, and construction sites. Advanced surveillance technology with 24/7 support to keep your property secure.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-[#2c6e49] hover:bg-[#245a3d] text-white">
                Get Free Quote
              </Button>
              <Button size="lg" variant="outline" className="border-[#2c6e49] text-[#2c6e49] hover:bg-[#2c6e49] hover:text-white">
                View Our Work
              </Button>
            </div>
            ...
            <div className="flex items-center gap-8 pt-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-[#2c6e49]">500+</div>
                <div className="text-sm text-gray-600">Projects Completed</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[#2c6e49]">50+</div>
                <div className="text-sm text-gray-600">Construction Sites</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-[#2c6e49]">24/7</div>
          ...
          <div className="relative">
            ...
            <div className="absolute -top-4 -left-4 bg-white p-4 rounded-xl shadow-lg border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-gray-900">HD Cameras</div>
            ...
            <div className="absolute -bottom-4 -right-4 bg-white p-4 rounded-xl shadow-lg border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Certified Installers</div>
                </div>
              </div>
            </div>
          </div>
